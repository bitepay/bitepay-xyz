                ...
                <div className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                  <img className="animate-bounce mx-auto" src="table-icon.svg" alt="table-icon"/>
                    ...
                    <div>
                        ...
                        <input aria-label="enter email adress" role="input" type="text" value={user.username} className="bg-gray-200 border rounded focus:outline-none text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" onChange={handleInput}/>
                    </div>
                    <div className="mt-8">
                        <button role="button" aria-label="create my account" className="focus:ring-2 focus:ring-offset-2 focus:ring-green-700 text-sm font-semibold leading-none text-white focus:outline-none bg-green-700 border rounded hover:bg-indigo-600 py-4 w-full" onClick={handleSubmit}>
                            JOIN TABLE
                        </button>
                    </div>
                </div>
