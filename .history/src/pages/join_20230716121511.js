...
export default function Join() {
  ...
  */
  ...
  const handleInput = (e) => {
    e.preventDefault()
    setUser((prevUser) => ({...user, username: e.target.value}))
  }
                ...
                <div className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                  <img className="animate-bounce mx-auto" src="table-icon.svg" alt="table-icon"/>
                    ...
                    <div>
                        ...
                        <input aria-label="enter email adress" role="input" type="text" value={user.username} className="bg-gray-200 border rounded focus:outline-none text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" onChange={(e) => handleInput(e)}/>
                    </div>
                    <div className="mt-8">
