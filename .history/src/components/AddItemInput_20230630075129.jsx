...
export const AddItemInput = ({ handleUserUpdate, user, setUser, handleTipUpdate, tableMembers, userUpdateTip }) => {
	...
	const updateTip = (e) => {
		...
		userUpdateTip(user, parseInt(e.target.value));
	}
			...
			<div className="card-body">
				...
				<div hidden={user.status !== 'READY'}>
					<div className="flex flex-col items-center">
						...
						<input type="range" className="range" min={15} max={30} value={user.tip} step={1} onMouseUp={(e) => handleTipUpdate(e)} onTouchEnd={(e) => handleTipUpdate(e)}/>
