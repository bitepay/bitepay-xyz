...
export const AddItemInput = ({ handleUserAdd, user }) => {
	...
	return (
		<div className="join px-auto">

			<div>
				<input className="input input-bordered join-item" placeholder="Item name..." value={itemName} onChange={(e) => {setItemName(e.target.value)}}/>
			</div>

			<div>
				<input className="input input-bordered join-item" placeholder="Price" type="number" value={itemPrice} onChange={(e) => {setItemPrice(e.target.value)}}/>
			</div>
