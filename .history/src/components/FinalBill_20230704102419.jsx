      ...
      <div className="h-auto w-full card bg-base-300 rounded-box place-items-center">
        ...
        <div className="flex justify-between w-full text-center">
          <div className="flex flex-col mx-auto">
            <img className="p-2" width="48" height="48" src="https://img.icons8.com/color/48/donate.png" alt="donate"/>
            <h2 className="md:text-md text-xs font-medium">AVG. TIP</h2>
            <p>{calculateTableTip(tableMembers)}%</p>
          </div>
          <div className="flex flex-col mx-auto">
            <img className="p-2" width="48" height="48" src="https://img.icons8.com/fluency/48/tip.png" alt="tip"/>
