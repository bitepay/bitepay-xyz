...
export const JoinTableComponent = () => {
    ...
    return (
        ...
        {/* Open the modal using ID.showModal() method */}
            <button className="btn mx-auto bg-green-400 text-white" onClick={()=>window.my_modal_5.showModal()}>GET STARTED!</button>
                ...
                <form method="dialog" className="modal-box bg-neutral-200">
                    ...
                    <div className="flex flex-col">
                        <div class="form-control">
                            <label class="label">
                                <span class="label-text">Have your mates know who you are... It helps your table&apos;s proprietary honor system!</span>
                            </label>
