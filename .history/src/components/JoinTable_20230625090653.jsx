          ...
          <div className="flex flex-col">
            <div className="form-control">
              ...
              <label className="input-group">
                <span>Name</span>
                <input id="userName" type="text" placeholder="Don't be that guy" className="input input-bordered" onChange={(e) => setUser({...user, username: e.target.value })}/>
              </label>
              <label className="label">
              ...
              <label className="input-group">
                <span>Table ID</span>
                <input id="tableID" type="number" placeholder="0000000" className="input input-bordered" onChange={(e) => setUser((prevUser) => prevUser.tableID = parseInt(e.target.value))}/>
              </label>
            </div>
          </div>
