...
import { calculateTotal, calculateTableTip, calculateBeforeTax, calculateTax, calculateTip } from '@/utils/utils'
...
export const FinalBill = ({ tableMembers }) => {
    ...
    return (
      <div className="collapse collapse-arrow join-item border border-base-300 dark:text-black">
        ...
        <div className="collapse-content dark:text-slate-700"> 
          ...
          <table className="table table-auto table-xs text-center">
            <thead>
              <tr>
                <th></th> 
                <th></th> 
  ...
  return (
    <>
      ...
      <div className="badge badge-ghost h-auto text-2xl">$ {calculateTotal(tableMembers)}</div>
