...
export const ProgressBar = ({ tableMembers, user, handleUserUpdate }) => {
  ...
  return (
    <section className="container mx-auto font-mono">
      <div className="w-full flex items-center justify-between mb-.5 mx-auto overflow-hidden rounded-lg shadow-lg bg-gray-100 uppercase border-b border-gray-100">
