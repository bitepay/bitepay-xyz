          ...
          <tbody>
            ...
            <tr>
              <td className="p-2 whitespace-nowrap">
                <div className="text-left text-sm text-blue-300">NY TAX:</div>
              </td>
              <td className="p-2 whitespace-nowrap">
                <div className="text-center">------------</div>
              </td>
              <td className="p-2 whitespace-nowrap">
                <div className="text-sm text-center  text-blue-300">8.875%</div>
              </td>
            </tr>
            <tr>
              <td className="p-2 whitespace-nowrap">
                <div className="text-left text-sm text-blue-300">MY TIP:</div>
              </td>
              <td className="p-2 whitespace-nowrap">
                <div className="text-center">------------</div>
              </td>
              <td className="p-2 whitespace-nowrap">
                <div className="text-sm text-center  text-blue-300">${Math.round(100 * ((1 + (user.tip / 100)) * user.total )) / 100}</div>
              </td>
            </tr>
            <tr>
              <td className="p-2 whitespace-nowrap">
