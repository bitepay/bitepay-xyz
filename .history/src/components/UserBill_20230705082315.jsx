      ...
      <div className="collapse-title">
        ...
        <div className="flex justify-around">
          ...
          <div className="text-sm md:text-lg font-light my-auto">
            TOTAL{': $ '}
            <div className={`badge md:badge-lg md:text-lg ${user.status === 'READY' ? 'badge-primary' : 'badge-neutral'}`}>
              {user.status === 'READY' ? 
        ...
        <table className="table-auto mx-auto text-center">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="p-2 whitespace-nowrap">
                <div className="text-sm text-center  text-blue-400">$ {Math.round(100 * user.total) / 100}</div>
              </td>
            </tr>
            <tr>
              <td className="p-2 whitespace-nowrap">
                <div className="text-left text-sm text-blue-400">NY TAX: <span className="text-xs text-blue-300">8.875%</span></div>
              </td>
              <td className="p-2 whitespace-nowrap">
                <div className="text-center">-----</div>
              </td>
              <td className="p-2 whitespace-nowrap">
                <div className="text-sm text-center  text-blue-400">$ {Math.round(100 * (user.total * .08875)) / 100}</div>
              </td>
            </tr>
