			...
			<div className="card-body">
				...
				<div hidden={user.status !== 'READY'}>
					<div className="flex flex-col items-center">
						...
						<input type="range" className="range" min={15} max={30} value={user.tip} step={1} onMouseUp={(e) => userUpdateTip(user, e.target.value)} onTouchEnd={(e) => userUpdateTip(user, e.target.value)}/>
