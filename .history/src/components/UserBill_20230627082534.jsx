    ...
    <div className="collapse collapse-arrow bg-base-200 m-1">
      ...
      <div className="collapse-title">
        ...
        <div className="flex justify-between">
          ...
          <div className={`badge badge-sm ${user.status === 'READY' ? 'badge-accent' : 'badge-secondary badge-outline'}`}>
            {user.status === 'READY' ? 'READY' : 'IN PROGRESS'}
          </div>
          <div className="font-light">
            TOTAL{': $ '}
            <div className={`badge badge-lg w-1/3 ${user.status === 'READY' ? 'badge-primary' : 'badge-neutral'}`}>
              {user.total}
            </div>
          </div>
