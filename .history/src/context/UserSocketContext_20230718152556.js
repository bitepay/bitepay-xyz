...
export const UserSocketProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    const socket = io('https://socket.bitepay.xyz', { 
    ...
    socket.on('disconnect', () => { 
      ...
      alert('Your real-time connection was interrupted. Please make sure you have are connected to a reliable network before re-joining your friends.')
